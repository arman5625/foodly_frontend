    ...
    return async (dispatch) => {
        ...
        try {
            const response = await api.get(`/api/carts/${reqData.cartId}/items`,
                ...
                {
                    headers: {
                        Authorization: `Beare ${reqData.token}`,
                    },
                });
