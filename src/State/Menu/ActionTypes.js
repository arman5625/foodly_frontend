...
export const DELTE_MENU_ITEM_REQUEST = 'DELTE_MENU_ITEM_REQUEST';
export const DELTE_MENU_ITEM_SUCCESS = 'DELTE_MENU_ITEM_SUCCESS';
export const DELTE_MENU_ITEM_FAILURE = 'DELTE_MENU_ITEM_FAILURE';
