...
export const GET_RESTAURENT_EVENTS_REQUEST = "GET_RESTAURENT_EVENTS_REQUEST";
export const GET_RESTAURENT_EVENTS_SUCCESS = "GET_RESTAURENT_EVENTS_SUCCESS";
export const GET_RESTAURENT_EVENTS_FAILURE = "GET_RESTAURENT_EVENTS_FAILURE";

export const CREATE_CATEGORY_REQUEST = "CREATE_CATEGORY_REQUEST";
export const CREATE_CATEGORY_SUCCESS = "CREATE_CATEGORY_SUCCESS";
export const CREATE_CATEGORY_FAILURE = "CREATE_CATEGORY_FAILURE";

export const GET_RESTAURENT_CATEGORY_REQUEST = "GET_RESTAURENT_CATEGORY_REQUEST";
export const GET_RESTAURENT_CATEGORY_SUCCESS = "GET_RESTAURENT_CATEGORY_SUCCESS";
export const GET_RESTAURENT_CATEGORY_FAILURE = "GET_RESTAURENT_CATEGORY_FAILURE";
