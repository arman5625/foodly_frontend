    ...
    <div className='pb-10'>
        ...
        items-center'>
            <div className="w-[50vw] z-10 text-center">
                <p className='text-2xl lg:text-6xl font-bold z-10 py-5'>foodly</p>
        ...
        <section className='p-10 lg:py-10 lg:px-20'>
            <p className='text-start text-2xl font-semibold text-gray-400 py-3 pb-10'>
                Top Meels
            </p>
            <MultiItemCarousel />
        </section>
        <section className='px-5 lg:px-20 pt-10'>
            <h1 className='text-2xl text-start font-semibold test-gray-400 pb-8'>
